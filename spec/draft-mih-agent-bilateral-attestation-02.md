  ...
  PeerReview2007:
    ...
    author:
      - ins: A. Haeberlen
        ...
        organization: MPI-SWS and Rice University
      - ins: P. Kouznetsov
        name: Petr Kouznetsov
        organization: MPI-SWS
      - ins: P. Druschel
        name: Peter Druschel
        organization: MPI-SWS
    date: 2007
    ...
    target: https://doi.org/10.1145/1294261.1294279
    refcontent: "Proceedings of the 21st ACM SIGOPS Symposium on Operating Systems Principles (SOSP '07), pp. 175-188"
--- abstract
...
**Accountability without a third party.** The general mechanism this document
...
detectable without a trusted arbiter — is not new. {{PeerReview2007}}
...
node-to-node accountability protocol does not: (a) an **agent-action**
...
arbitrary distributed-system state; (b) **asymmetric endings** that
